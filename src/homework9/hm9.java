        ...
        do {
            ...
            switch (userInput) {
                case 1:
                    ...
                    circle.setLeg(radius);
                    circlesArr[countCircle++] = new Circle();
                    break;
                case 2:
                    ...
                    triangle.setLeg(legFirst, legSecond, legThird, heightToFirstLeg);
                    trianglesArr[countTriangle++] = triangle;
                    break;
                case 3:
                    ...
                    rectangle.setLeg(sideFirst, sideSecond);
                    rectanglesArr[countRectangle++] = rectangle;
                    break;
                case 0:
